...
public class Login extends javax.swing.JFrame {
    ...
    private void loginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_loginActionPerformed
        ...
        try (FileReader archivo = new FileReader("C:/Users/ANDRE/Desktop/Usuarios.txt");
             BufferedReader buffer = new BufferedReader(archivo)) {

            String contenido;
            while ((contenido = buffer.readLine()) != null && encontrado==false) {
                String[] partes = contenido.split(" ");

                if (usuario.equals(partes[0]) && contra.equals(partes[1])) {
                //    System.out.println("Login exitoso");
                    jLabel5.setText("Login exitoso");
